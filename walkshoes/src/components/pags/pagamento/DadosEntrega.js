        ...
        <div className="div-etapa-entrega"> 
            ...
            <div>
                <form onSubmit={handleSubmit}>
                    <div className="dados">
                        <label> CEP </label>
                        <input type="text" placeholder="Digite seu CEP" name="cep" onChange={(event) => setCep(event.target.value)}/> 

                        <label> Rua </label>
                        <input type="text" placeholder="Digite sua Rua" name="rua" onChange={(event) => setRua(event.target.value)}/> 
